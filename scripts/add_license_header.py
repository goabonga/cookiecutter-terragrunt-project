...
# Directories that never carry the project's own sources: VCS metadata,
# virtualenvs, build output, tool caches - and the Cookiecutter template
# tree, whose files belong to the user's generated project and must NOT
# inherit this repository's copyright header.
PRUNE_DIRS = {
    ".git",
    ".venv",
    "venv",
